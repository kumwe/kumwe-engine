...
The newest published 1.x source release on PHP 8.5 (NTS or ZTS)/Linux x86_64 is the supported
line; consumers must use its latest patch. Development snapshots, superseded patches and
...
advisory records; each binding release embeds the Engine release of the same version, whose archive
checksum and GitHub OIDC build provenance are verified before embedding.
